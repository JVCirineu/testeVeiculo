...
// Given / Arrange
		Cliente cliente1 = new Cliente(null, "David", "(15)997856473", "23423456789", "43543656");
...
//given / Arrange 
		Cliente Cliente1 = new Cliente(null, "David", "(15)997856473", "23423456789", "43543656");
		Cliente Cliente2 = new Cliente(null, "Pedro", "(15)997856473", "23423456789", "43543659");
...
//given / Arrange 
		Cliente cliente1 = new Cliente(null, "David", "(15)997856473", "23423456789", "43543659");
		clienteRepository.save(cliente1);
...
//given / Arrange 
		...
		clienteRepository.save(cliente1);
//when / Act 
		clienteRepository.delete(cliente1.getId());
